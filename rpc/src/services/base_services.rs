...
#[cached(name = "BLOCK_HASH_CACHE", type = "TimedCache<(ChainId,BlockHash,Option<i32>,usize), Vec<BlockHash>>", create = "{TimedCache::with_lifespan(TIMED_SIZED_CACHE_TTL_IN_SECS)}", convert = "{(_chain_id.clone(),block_hash.clone(),every_nth_level,limit)}", result = true)]
...
/// Get block metadata
#[cached(name = "BLOCK_METADATA_CACHE", type = "TimedSizedCache<(ChainId,BlockHash), BlockMetadata>", create = "{TimedSizedCache::with_size_and_lifespan(TIMED_SIZED_CACHE_SIZE,TIMED_SIZED_CACHE_TTL_IN_SECS)}", convert = "{(chain_id.clone(),block_hash.clone())}", result = true)]
...
#[cached(name = "BLOCK_SHELL_HEADER_CACHE", type = "TimedSizedCache<(ChainId,BlockHash), Option<BlockHeaderShellInfo>>", create = "{TimedSizedCache::with_size_and_lifespan(TIMED_SIZED_CACHE_SIZE,TIMED_SIZED_CACHE_TTL_IN_SECS)}", convert = "{(_chain_id.clone(),block_hash.clone())}", result = true)]
...
#[cached(name = "LIVE_BLOCKS_CACHE", type = "TimedSizedCache<(ChainId,BlockHash), Vec<String>>", create = "{TimedSizedCache::with_size_and_lifespan(TIMED_SIZED_CACHE_SIZE,TIMED_SIZED_CACHE_TTL_IN_SECS)}", convert = "{(_chain_id.clone(),block_hash.clone())}", result = true)]
...
#[cached(name = "CONTEXT_RAW_BYTES_CACHE", type = "TimedSizedCache<(BlockHash,Option<String>,Option<usize>), StringTreeEntry>", create = "{TimedSizedCache::with_size_and_lifespan(TIMED_SIZED_CACHE_SIZE,TIMED_SIZED_CACHE_TTL_IN_SECS)}", convert = "{(block_hash.clone(),prefix.clone(),depth.clone())}", result = true)]
...
#[cached(name = "BLOCK_PROTOCOLS_CACHE", type = "TimedSizedCache<(ChainId,BlockHash), Protocols>", create = "{TimedSizedCache::with_size_and_lifespan(TIMED_SIZED_CACHE_SIZE,TIMED_SIZED_CACHE_TTL_IN_SECS)}", convert = "{(_chain_id.clone(),block_hash.clone())}", result = true)]
...
/// Extract the current_protocol and the next_protocol from the block metadata
#[cached(name = "BLOCK_ADDITIONAL_DATA_CACHE", type = "TimedSizedCache<(ChainId,BlockHash), Option<BlockAdditionalData>>", create = "{TimedSizedCache::with_size_and_lifespan(TIMED_SIZED_CACHE_SIZE,TIMED_SIZED_CACHE_TTL_IN_SECS)}", convert = "{(_chain_id.clone(),block_hash.clone())}", result = true)]
...
#[cached(name = "BLOCK_OPERATION_HASHES_CACHE", type = "TimedSizedCache<(ChainId,BlockHash), Vec<BlockOperationsHashes>>", create = "{TimedSizedCache::with_size_and_lifespan(TIMED_SIZED_CACHE_SIZE,TIMED_SIZED_CACHE_TTL_IN_SECS)}", convert = "{(chain_id.clone(),block_hash.clone())}", result = true)]
...
#[cached(name = "BLOCK_OPERATION_VP_CACHE", type = "TimedSizedCache<(ChainId,BlockHash,usize), BlockValidationPass>", create = "{TimedSizedCache::with_size_and_lifespan(TIMED_SIZED_CACHE_SIZE,TIMED_SIZED_CACHE_TTL_IN_SECS)}", convert = "{(chain_id.clone(),block_hash.clone(),validation_pass)}", result = true)]
...
#[cached(name = "BLOCK_CACHE", type = "TimedSizedCache<(ChainId,BlockHash), BlockInfo>", create = "{TimedSizedCache::with_size_and_lifespan(TIMED_SIZED_CACHE_SIZE,TIMED_SIZED_CACHE_TTL_IN_SECS)}", convert = "{(chain_id.clone(),block_hash.clone())}", result = true)]
