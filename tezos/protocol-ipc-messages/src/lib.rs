...
use tezos_api::ffi::{
    ...
    PreCheckOperationError, PreCheckOperationResponse, PreFilterOperationError,
    PreFilterOperationResponse, PreapplyBlockError, PreapplyBlockRequest, PreapplyBlockResponse,
    PrevalidatorWrapper, ProtocolDataError, ProtocolRpcError, ProtocolRpcRequest,
    ProtocolRpcResponse, RestoreContextError, RustBytes, TezosRuntimeConfiguration,
...
pub enum ProtocolMessage {
    ...
    PreCheckOperation(ValidateOperationRequest),
...
pub enum NodeMessage {
    ...
    PreCheckOperationResult(Result<PreCheckOperationResponse, PreCheckOperationError>),
