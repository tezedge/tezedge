...
//! Tests for apply first blocks for protocol V4 based like 011 hangzhou
...
#[test]
#[serial]
fn test_bootstrap_empty_storage_with_first_four_blocks_protocol_v4() {
    init_test_runtime();
    ...
    assert_block_metadata_hash(
        test_data_protocol_v4::BLOCK_HEADER_LEVEL_1_BLOCK_METADATA_HASH,
        &apply_block_result.block_metadata_hash,
    );
    assert_operation_metadata_hash(
        test_data_protocol_v4::BLOCK_HEADER_LEVEL_1_OPERATION_METADATA_LIST_LIST_HASH,
        &apply_block_result.ops_metadata_hash,
    );
    assert_operation_metadata_hashes(
        test_data_protocol_v4::block_header_level1_operation_metadata_hashes(),
    ...
    assert_block_metadata_hash(
        test_data_protocol_v4::BLOCK_HEADER_LEVEL_2_BLOCK_METADATA_HASH,
        &apply_block_result.block_metadata_hash,
    );
    assert_operation_metadata_hash(
        test_data_protocol_v4::BLOCK_HEADER_LEVEL_2_OPERATION_METADATA_LIST_LIST_HASH,
        &apply_block_result.ops_metadata_hash,
    );
    assert_operation_metadata_hashes(
        test_data_protocol_v4::block_header_level2_operation_metadata_hashes(),
        &apply_block_result.ops_metadata_hashes,
    );
    ...
    let apply_block_result =
        apply_encoded_message(ProtocolMessage::ApplyBlockCall(ApplyBlockRequest {
            chain_id: chain_id.clone(),
            block_header: BlockHeader::from_bytes(
                hex::decode(test_data_protocol_v4::BLOCK_HEADER_LEVEL_3).unwrap(),
            )
            .unwrap(),
            pred_header: BlockHeader::from_bytes(
                hex::decode(test_data_protocol_v4::BLOCK_HEADER_LEVEL_2).unwrap(),
            ...
            operations: ApplyBlockRequest::convert_operations(
                test_data_protocol_v4::block_operations_from_hex(
                    test_data_protocol_v4::BLOCK_HEADER_HASH_LEVEL_3,
                    test_data_protocol_v4::block_header_level3_operations(),
                ),
            ),
            max_operations_ttl: apply_block_result.max_operations_ttl,
            predecessor_block_metadata_hash: apply_block_result.block_metadata_hash,
    ...
    assert_eq!(
        test_data_protocol_v4::context_hash(
            test_data_protocol_v4::BLOCK_HEADER_LEVEL_3_CONTEXT_HASH
        ),
        apply_block_result.context_hash
    );
    ...
    assert_block_metadata_hash(
        test_data_protocol_v4::BLOCK_HEADER_LEVEL_3_BLOCK_METADATA_HASH,
        &apply_block_result.block_metadata_hash,
    );
    assert_operation_metadata_hash(
        test_data_protocol_v4::BLOCK_HEADER_LEVEL_3_OPERATION_METADATA_LIST_LIST_HASH,
        &apply_block_result.ops_metadata_hash,
    );
    assert_operation_metadata_hashes(
        test_data_protocol_v4::block_header_level3_operation_metadata_hashes(),
        &apply_block_result.ops_metadata_hashes,
    );
    ...
    let apply_block_result =
        apply_encoded_message(ProtocolMessage::ApplyBlockCall(ApplyBlockRequest {
            chain_id,
            block_header: BlockHeader::from_bytes(
                hex::decode(test_data_protocol_v4::BLOCK_HEADER_LEVEL_4).unwrap(),
            )
            .unwrap(),
            pred_header: BlockHeader::from_bytes(
                hex::decode(test_data_protocol_v4::BLOCK_HEADER_LEVEL_3).unwrap(),
            ...
            operations: ApplyBlockRequest::convert_operations(
                test_data_protocol_v4::block_operations_from_hex(
                    test_data_protocol_v4::BLOCK_HEADER_HASH_LEVEL_4,
                    test_data_protocol_v4::block_header_level4_operations(),
                ),
            ),
            max_operations_ttl: apply_block_result.max_operations_ttl,
            predecessor_block_metadata_hash: apply_block_result.block_metadata_hash,
    ...
    assert_eq!(
        test_data_protocol_v4::context_hash(
            test_data_protocol_v4::BLOCK_HEADER_LEVEL_4_CONTEXT_HASH
        ),
        apply_block_result.context_hash
    );
    ...
    assert_block_metadata_hash(
        test_data_protocol_v4::BLOCK_HEADER_LEVEL_4_BLOCK_METADATA_HASH,
        &apply_block_result.block_metadata_hash,
    );
    assert_operation_metadata_hash(
        test_data_protocol_v4::BLOCK_HEADER_LEVEL_4_OPERATION_METADATA_LIST_LIST_HASH,
        &apply_block_result.ops_metadata_hash,
    );
    assert_operation_metadata_hashes(
        test_data_protocol_v4::block_header_level4_operation_metadata_hashes(),
        &apply_block_result.ops_metadata_hashes,
    );
}
...
fn test_bootstrap_empty_storage_with_first_two_blocks_and_check_result_json_metadata() {
    ...
    let operations =
        ApplyBlockRequest::convert_operations(test_data_protocol_v4::block_operations_from_hex(
            test_data_protocol_v4::BLOCK_HEADER_HASH_LEVEL_3,
            test_data_protocol_v4::block_header_level3_operations(),
        ));
