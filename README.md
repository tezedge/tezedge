...
```
docker run -i -p 9732:9732 -p 18732:18732 -p 4927:4927 -t tezedge/tezedge:v1.6.3 --network=mainnet --p2p-port 9732 --rpc-port 18732 --websocket-address 0.0.0.0:4927
```
