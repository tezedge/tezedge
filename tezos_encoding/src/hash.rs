...
pub mod prefix {
    ...
    pub const BLOCK_HEADER: [u8; 2] = [1, 52];
    pub const CONTEXT: [u8; 2] = [79, 199];
    pub const OPERATION_HASH: [u8; 2] = [5, 116];
    pub const OPERATIONS_LIST_HASH: [u8; 3] = [29, 159, 109];
}
...
mod tests {
    ...
    fn test_encode_block_header() -> Result<(), failure::Error> {
        let decoded = to_prefixed_hash(&prefix::BLOCK_HEADER, hex::decode("46a6aefde9243ae18b191a8d010b7237d5130b3530ce5d1f60457411b2fa632d")?);
    ...
    fn test_encode_context() -> Result<(), failure::Error> {
        let decoded = to_prefixed_hash(&prefix::CONTEXT, hex::decode("934484026d24be9ad40c98341c20e51092dd62bbf470bb9ff85061fa981ebbd9")?);
    ...
    fn test_encode_operations_hash() -> Result<(), failure::Error> {
        let decoded = to_prefixed_hash(&prefix::OPERATIONS_LIST_HASH, hex::decode("acecbfac449678f1d68b90c7b7a86c9280fd373d872e072f3fb1b395681e7149")?);
