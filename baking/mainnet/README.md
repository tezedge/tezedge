...
2. #### **Download snapshot data**
   ...
   At first, you need to check, which snapshot to download, open a browser here: http://65.21.165.81:9999/
   ...
   wget -m -np -nH -R 'index.html*' http://65.21.165.81:9999/tezedge_1784665_2021-10-17T12:04:10.670066045+00:00/ -P $HOME/data-mainnet
   ```
   ...
   ```
   cd $HOME/data-mainnet
   scp -r <user>@65.21.165.81:/usr/local/etc/tezedge-data/tezedge_1784665_2021-10-17T12:04:10.670066045+00:00 $HOME/data-mainnet
   passwd: <password>
   ```
