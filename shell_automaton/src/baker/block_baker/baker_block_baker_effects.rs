...
use super::{
    ...
    BakerBlockBakerComputeOperationsPathsSuccessAction, BakerBlockBakerInjectInitAction,
    BakerBlockBakerInjectPendingAction, BakerBlockBakerInjectSuccessAction,
    BakerBlockBakerPreapplyInitAction, BakerBlockBakerPreapplyPendingAction,
    BakerBlockBakerPreapplySuccessAction, BakerBlockBakerRightsGetCurrentLevelSuccessAction,
    BakerBlockBakerRightsGetInitAction, BakerBlockBakerRightsGetNextLevelSuccessAction,
    BakerBlockBakerRightsGetPendingAction, BakerBlockBakerRightsGetSuccessAction,
    BakerBlockBakerRightsNoRightsAction, BakerBlockBakerSignPendingAction,
    BakerBlockBakerSignSuccessAction, BakerBlockBakerState, BakerBlockBakerTimeoutPendingAction,
        ...
        Action::BakerBlockBakerSignPending(content) => {
            let header = match store.state.get().bakers.get(&content.baker) {
                Some(v) => match &v.block_baker {
                    BakerBlockBakerState::ComputeOperationsPathsSuccess { header, .. } => header,
                    _ => return,
                },
                None => return,
            };
