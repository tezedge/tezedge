...
impl Mutator<SocketAddr> for SocketAddrMutator {
    ...
    #[doc(hidden)]
    #[no_coverage]
    fn validate_value(&self, _value: &SocketAddr) -> Option<()> {
        Some(())
    }
...
impl Mutator<IpAddr> for IpAddrMutator {
    ...
    #[doc(hidden)]
    #[no_coverage]
    fn validate_value(&self, _value: &IpAddr) -> Option<()> {
        Some(())
    }

    #[doc(hidden)]
    #[no_coverage]
    fn default_mutation_step(&self, _value: &IpAddr, _cache: &Self::Cache) -> Self::MutationStep {
        INITIAL_MUTATION_STEP
    }
...
impl Mutator<PeerToken> for PeerTokenMutator {
    ...
    #[doc(hidden)]
    #[no_coverage]
    fn validate_value(&self, _value: &PeerToken) -> Option<()> {
        Some(())
    }
