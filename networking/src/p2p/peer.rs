...
pub enum PeerError {
    #[fail(
        display = "Unsupported protocol - supported_version: {} vs. {}",
        supported_version, incompatible_versions
    )]
    UnsupportedProtocol {
...
pub async fn bootstrap(
    ...
    let protocol_not_supported = !connection_message
        .versions()
        .iter()
        .any(|version| supported_protocol_version.supports(version));
